...
public class AuditEvent implements Serializable {
		...
		public String toString() {
			return "AuditEvent [userId=" + userId + ", companyId=" + companyId + ", remoteClientIp=" + remoteClientIp
					...
					+ ", criticalFieldValue=" + criticalFieldValue + ", timeStamp=" + timeStamp + ", serverId="
					+ serverId + ", action=" + action + ", isBlob=" + isBlob + ", applicationName=" + applicationName
					+ ", methodName=" + methodName + ", uiPage=" + uiPage + ", browserInfo=" + browserInfo + ", osInfo="
					+ osInfo + ", mobileInfo=" + mobileInfo + ", auditData=" + auditData + "]";
		}
